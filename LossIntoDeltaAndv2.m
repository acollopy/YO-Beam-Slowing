...
%Loss into v = 2;  3000 photons before going into v = 2;  
...
%   XV(9,:) = (ceil(hvs(rsn-LossFractionv2-LossFractionDelta))-ceil(hvs(LossFractionDelta-rsn))).*StateStart(1,:);
...
%      XV(9,:) = (ceil(hvs(rsn-LossFractionv2-LossFractionDelta))-ceil(hvs(LossFractionDelta-rsn)));
%     XV(9,:) = (ceil(hvs(rsn-(LossFractionv2-LossFractionDelta)))-ceil(hvs(LossFractionDelta-rsn))).*StateNew(1,:);
%  temp = (ceil(rsn-LossFractionv2-LossFractionDelta) - ceil(LossFractionDelta-rsn));
